  ...
  return (
    <>
      <div className="contain">
        <h1 className="title text-3xl md:text-7xl font-bold dark:text-white text-center">
          Walchand Linux
        </h1>
        <h1 className="title2 text-3xl md:text-7xl font-bold dark:text-white text-center">
          Users' Group
        </h1>
